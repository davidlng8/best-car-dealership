...
def initiate():
    car_make_data = [
        ...
        {"name":"Audi", "description":"Great cars. German technology", "color": "YELLOW"},
        {"name":"Kia", "description":"Great cars. Korean technology", "color": "BLACK"},
        {"name":"Toyota", "description":"Great cars. Japanese technology", "color" : "SILVER"},
    ]

    car_make_instances = []
    for data in car_make_data:
        car_make_instances.append(CarMake.objects.create(name=data['name'], description=data['description'], color=data['color']))
